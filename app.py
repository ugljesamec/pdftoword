...
root.iconbitmap("pdf-file.ico")

label = tk.Label(root, text="PDF to WORD(docx) Converter", font=("Arial", 16), padx=5, pady=5)
label.pack()

pdf_path_label = tk.Label(root, font=("Arial", 12), text="Select PDF File:")
pdf_path_label.pack()
pdf_path_entry = tk.Entry(root, width=50)
pdf_path_entry.pack()
pdf_path_button = tk.Button(root, text="Browse", font=("Arial", 12), command=choose_pdf_file)
pdf_path_button.pack(padx=5, pady=5)

docx_destination_label = tk.Label(root, font=("Arial", 12), text="Select Destination for DOCX:")
docx_destination_label.pack()
docx_destination_entry = tk.Entry(root, width=50)
docx_destination_entry.pack()
docx_destination_button = tk.Button(root, text="Browse", font=("Arial", 12), command=choose_docx_destination)
docx_destination_button.pack(padx=5, pady=5)

convert_button = tk.Button(root, text="Convert", font=("Arial", 12), command=convert_pdf_to_docx)
...
attribution_label = tk.Label(root, fg="gray", font=("Arial", 10), text="This software has been developed by Šamec Uglješa")
